...
- Ban đầu, tôi nghĩ đến phương pháp lưu hash table của các bàn dưới dạng vector, hash table này đã đi kèm luôn cả thứ tự, tuy nhiên lựa chọn kiểu dữ liệu gì cho mỗi bàn
là hơi khó. nếu với mỗi bàn ta lưu một vector các món ăn, như vậy thì khi có thêm một món ăn mới ta phải duyệt toàn bộ vector để tăng thêm số lượng, việc này tăng độ phức tạp.
Như vậy, ta có thể dùng một unordered_map và đếm số lượng món ăn. 
...
- Cách này tôi nghĩ là tốt hơn, nhưng sau khi implement thì thấy hơi phức tạp vì ngược với hướng suy nghĩ thông thường. Ngoài ra vẫn phải lưu thêm 1 set các bàn có khách.
Vì vậy độ phức tạp không gian cũng không khác gì phương pháp trước cho lắm.
